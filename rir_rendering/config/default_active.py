...
def get_config(
	...
	if config.UNIFORM_SAMPLE:
		if 'MOVE_FORWARD_COLLECT' in config.TASK_CONFIG.TASK.POSSIBLE_ACTIONS:
			config.TASK_CONFIG.TASK.POSSIBLE_ACTIONS.remove('MOVE_FORWARD_COLLECT')
		if 'TURN_LEFT_COLLECT' in config.TASK_CONFIG.TASK.POSSIBLE_ACTIONS:
			config.TASK_CONFIG.TASK.POSSIBLE_ACTIONS.remove('TURN_LEFT_COLLECT')
		if 'TURN_RIGHT_COLLECT' in config.TASK_CONFIG.TASK.POSSIBLE_ACTIONS:
			config.TASK_CONFIG.TASK.POSSIBLE_ACTIONS.remove('TURN_RIGHT_COLLECT')
